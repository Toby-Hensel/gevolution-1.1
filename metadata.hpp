...
#define P_alpha_new       0.00          // default value for Alpha
#define P_beta_new        0.00          // default value for Alpha
#define P_Omega_new       0.00          // default value for Alpha
#define P_phi_new         0.00          // default value for Alpha
#define P_timestep_factor 2.00          // default value for Alpha
